...
var Dashboard = function() {
    ...
    var revenueChange = function() {
        ...
        Morris.Donut({
            ...
            colors: [
                mUtil.getColor('nativeandroid'),
                mUtil.getColor('shpofiy'),
                mUtil.getColor('frontend'),
                mUtil.getColor('design'),
                mUtil.getColor('laravel'),
                 mUtil.getColor('shopifyapp'),
                  mUtil.getColor('reactnative'),
                   mUtil.getColor('php'),
                    mUtil.getColor('magento'),
                mUtil.getColor('wordpress'),
